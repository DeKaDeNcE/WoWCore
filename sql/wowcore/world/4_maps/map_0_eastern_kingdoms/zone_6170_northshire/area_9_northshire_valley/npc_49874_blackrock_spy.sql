...
(      @ENTRY, @TALK_GROUP_ID,    0,                'Orc KILL $r!', @CHAT_MSG_MONSTER_SAY, @LANG_UNIVERSAL,           100, @EMOTE_ONESHOT_NONE,          0,       0,               0,             42876, @TEXT_RANGE_NORMAL, 'Blackrock Spy'),
(      @ENTRY, @TALK_GROUP_ID,    1,      'Blackrock take forest!', @CHAT_MSG_MONSTER_SAY, @LANG_UNIVERSAL,           100, @EMOTE_ONESHOT_NONE,          0,       0,               0,             42879, @TEXT_RANGE_NORMAL, 'Blackrock Spy'),
(      @ENTRY, @TALK_GROUP_ID,    2, 'The grapes were VERY TASTY!', @CHAT_MSG_MONSTER_SAY, @LANG_UNIVERSAL,           100, @EMOTE_ONESHOT_NONE,          0,       0,               0,             42880, @TEXT_RANGE_NORMAL, 'Blackrock Spy'),
(      @ENTRY, @TALK_GROUP_ID,    3,                    'Eat you!', @CHAT_MSG_MONSTER_SAY, @LANG_UNIVERSAL,           100, @EMOTE_ONESHOT_NONE,          0,       0,               0,             42878, @TEXT_RANGE_NORMAL, 'Blackrock Spy'),
(      @ENTRY, @TALK_GROUP_ID,    4,               'Beg for life!', @CHAT_MSG_MONSTER_SAY, @LANG_UNIVERSAL,           100, @EMOTE_ONESHOT_NONE,          0,       0,               0,             42877, @TEXT_RANGE_NORMAL, 'Blackrock Spy');

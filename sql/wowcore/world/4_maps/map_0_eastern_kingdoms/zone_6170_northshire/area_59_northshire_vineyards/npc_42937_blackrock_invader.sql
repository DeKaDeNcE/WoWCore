...
# Fix Combat Reach
UPDATE `creature_model_info` SET `CombatReach` = 1 WHERE `DisplayID` IN (33142, 33144, 33145, 33146);
...
(      @ENTRY, @TALK_GROUP_ID,    0,                'Orc KILL $r!',     12,          0,           100,       0,          0,       0,               0,             42876,           0, 'Blackrock Invader'),
(      @ENTRY, @TALK_GROUP_ID,    1,      'Blackrock take forest!',     12,          0,           100,       0,          0,       0,               0,             42879,           0, 'Blackrock Invader'),
(      @ENTRY, @TALK_GROUP_ID,    2, 'The grapes were VERY TASTY!',     12,          0,           100,       0,          0,       0,               0,             42880,           0, 'Blackrock Invader'),
(      @ENTRY, @TALK_GROUP_ID,    3,                    'Eat you!',     12,          0,           100,       0,          0,       0,               0,             42878,           0, 'Blackrock Invader'),
(      @ENTRY, @TALK_GROUP_ID,    4,               'Beg for life!',     12,          0,           100,       0,          0,       0,               0,             42877,           0, 'Blackrock Invader');

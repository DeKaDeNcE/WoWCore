...
namespace Game.Networking.Packets
{
    ...
    public class EnumCharactersResult : ServerPacket
    {
        ...
        public class CharacterInfo
        {
            ...
            public byte SexId;
            public Array<ChrCustomizationChoice> Customizations = new(ChrCustomizationChoice.Size);
    ...
    class CharCustomizeSuccess : ServerPacket
    {
        ...
        string CharName = "";
        byte SexID;
        Array<ChrCustomizationChoice> Customizations = new(ChrCustomizationChoice.Size);
    }

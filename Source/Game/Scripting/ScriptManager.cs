...
namespace Game.Scripting
{
    ...
    public class ScriptManager : Singleton<ScriptManager>
    {
        ...
        public void OnGuildMemberWithdrawMoney(Guild guild, Player player, ulong amount, bool isRepair)
        {
            ForEach<GuildScript>(p => p.OnMemberWithdrawMoney(guild, player, amount, isRepair));
        }

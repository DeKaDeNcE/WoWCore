...
namespace Game.Entities
{
    public partial class Player : Unit
    {
        ...
        public void SendInitialPacketsAfterAddToMap()
        {
            ...
            SetPlayerLocalFlag(PlayerLocalFlags.AccountSecured);    // Unlock Bag Slots TODO: Implement toggle from config

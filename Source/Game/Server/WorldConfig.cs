...
namespace Game;
    ...
    public class WorldConfig : ConfigMgr
    {
        public static void Load(bool reload = false)
        {
            ...
            {
                Log.outError(LogFilter.ServerLoading, "StartDeathKnightPlayerLevel ({0}) must be in range 1..MaxPlayerLevel({1}). Set to {2}.", Values[WorldCfg.StartDeathKnightPlayerLevel], Values[WorldCfg.MaxPlayerLevel], Values[WorldCfg.MaxPlayerLevel]);
                Values[WorldCfg.StartDeathKnightPlayerLevel] = Values[WorldCfg.MaxPlayerLevel];
            }
            ...
            {
                Log.outError(LogFilter.ServerLoading, "StartDemonHunterPlayerLevel ({0}) must be in range 1..MaxPlayerLevel({1}). Set to 1.", Values[WorldCfg.StartDemonHunterPlayerLevel], Values[WorldCfg.MaxPlayerLevel]);
            ...
            {
                Log.outError(LogFilter.ServerLoading, "StartDemonHunterPlayerLevel ({0}) must be in range 1..MaxPlayerLevel({1}). Set to {2}.", Values[WorldCfg.StartDemonHunterPlayerLevel], Values[WorldCfg.MaxPlayerLevel], Values[WorldCfg.MaxPlayerLevel]);
            ...
            {
                Log.outError(LogFilter.ServerLoading, "RecruitAFriend.MaxLevel ({0}) must be in the range 0..MaxLevel({1}). Set to {2}.", Values[WorldCfg.MaxRecruitAFriendBonusPlayerLevel], Values[WorldCfg.MaxPlayerLevel], 60);
            ...
            {
                Log.outError(LogFilter.ServerLoading, "GM.StartLevel ({0}) must be in range StartPlayerLevel({1})..{2}. Set to {3}.", Values[WorldCfg.StartGmLevel], Values[WorldCfg.StartPlayerLevel], SharedConst.MaxLevel, Values[WorldCfg.StartPlayerLevel]);
            ...
            if (reload)
            {
                ...
                Values[WorldCfg.Expansion] = GetDefaultValue("Expansion", Expansion.Dragonflight);
            ...
            Values[WorldCfg.CalculateGameObjectZoneAreaData] = GetDefaultValue("Calculate.GameObject.Zone.Area.Data", false);
            ...
            Values[WorldCfg.CreatureCheckInvalidPosition] = GetDefaultValue("Creature.CheckInvalidPosition", false);
            Values[WorldCfg.GameObjectCheckInvalidPosition] = GetDefaultValue("GameObject.CheckInvalidPosition", false);
        ...
        public static uint GetUIntValue(WorldCfg config) => Convert.ToUInt32(Values.LookupByKey(config));

        public static int GetIntValue(WorldCfg config) => Convert.ToInt32(Values.LookupByKey(config));

        public static ulong GetUInt64Value(WorldCfg config) => Convert.ToUInt64(Values.LookupByKey(config));

        public static bool GetBoolValue(WorldCfg config) => Convert.ToBoolean(Values.LookupByKey(config));

        public static float GetFloatValue(WorldCfg config) => Convert.ToSingle(Values.LookupByKey(config));

        public static void SetValue(WorldCfg config, object value)
        {
            Values[config] = value;
        }

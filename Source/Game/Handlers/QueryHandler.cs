...
namespace Game
{
    public partial class WorldSession
    {
        ...
        void HandleQueryRealmName(QueryRealmName queryRealmName)
        {
            ...
            if (Global.RealmMgr.GetRealmNames(realmHandle.Index, ref realmQueryResponse.NameInfo.RealmNameActual, ref realmQueryResponse.NameInfo.RealmNameNormalized))
            {

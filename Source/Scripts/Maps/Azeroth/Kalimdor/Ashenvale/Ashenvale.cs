...
namespace Scripts.Maps.Azeroth.Kalimdor.Ashenvale;
    ...
    public override void WaypointReached(uint waypointId, uint pathId)
    {
        ...
        switch (waypointId)
        {
            case 0:
                ...
                break;
            case 13:
                me.SummonCreature(CreatureIds.ThistlefurTotemic, Misc.RuulSnowhoofSummonsCoord[0], TempSummonType.DeadDespawn, TimeSpan.FromMilliseconds(60000));
                me.SummonCreature(CreatureIds.ThistlefurUrsa, Misc.RuulSnowhoofSummonsCoord[1], TempSummonType.DeadDespawn, TimeSpan.FromMilliseconds(60000));
                me.SummonCreature(CreatureIds.ThistlefurPathfinder, Misc.RuulSnowhoofSummonsCoord[2], TempSummonType.DeadDespawn, TimeSpan.FromMilliseconds(60000));
                break;
            case 19:
                me.SummonCreature(CreatureIds.ThistlefurTotemic, Misc.RuulSnowhoofSummonsCoord[3], TempSummonType.DeadDespawn, TimeSpan.FromMilliseconds(60000));
                me.SummonCreature(CreatureIds.ThistlefurUrsa, Misc.RuulSnowhoofSummonsCoord[4], TempSummonType.DeadDespawn, TimeSpan.FromMilliseconds(60000));
                me.SummonCreature(CreatureIds.ThistlefurPathfinder, Misc.RuulSnowhoofSummonsCoord[5], TempSummonType.DeadDespawn, TimeSpan.FromMilliseconds(60000));
                break;
            case 21:
...
public class npc_muglash : EscortAI
{
    ...
    void DoWaveSummon()
    {
        ...
        {
            case 1:
                me.SummonCreature(CreatureIds.WrathRider, Misc.FirstNagaCoord[0], TempSummonType.TimedDespawnOutOfCombat, TimeSpan.FromMilliseconds(60000));
                me.SummonCreature(CreatureIds.WrathSorceress, Misc.FirstNagaCoord[1], TempSummonType.TimedDespawnOutOfCombat, TimeSpan.FromMilliseconds(60000));
                me.SummonCreature(CreatureIds.WrathRazortail, Misc.FirstNagaCoord[2], TempSummonType.TimedDespawnOutOfCombat, TimeSpan.FromMilliseconds(60000));
                break;
            case 2:
                me.SummonCreature(CreatureIds.WrathPriestess, Misc.SecondNagaCoord[0], TempSummonType.TimedDespawnOutOfCombat, TimeSpan.FromMilliseconds(60000));
                me.SummonCreature(CreatureIds.WrathMyrmidon, Misc.SecondNagaCoord[1], TempSummonType.TimedDespawnOutOfCombat, TimeSpan.FromMilliseconds(60000));
                me.SummonCreature(CreatureIds.WrathSeawitch, Misc.SecondNagaCoord[2], TempSummonType.TimedDespawnOutOfCombat, TimeSpan.FromMilliseconds(60000));
                break;
            case 3:
                me.SummonCreature(CreatureIds.Vorsha, Misc.VorshaCoord, TempSummonType.TimedDespawnOutOfCombat, TimeSpan.FromMilliseconds(60000));
                break;
            case 4:

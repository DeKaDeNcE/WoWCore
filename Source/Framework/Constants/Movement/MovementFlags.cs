...
namespace Framework.Constants;
    ...
    public enum MovementFlag
    {
        ...
        MaskCreatureAllowed                 = Forward | DisableGravity | Root | Swimming | CanFly | WaterWalk | FallingSlow | Hover | DisableCollision,
        MaskPlayerOnly                      = Flying,
        MaskHasPlayerStatusOpcode           = DisableGravity | Root | CanFly | WaterWalk | FallingSlow | Hover | DisableCollision
    }

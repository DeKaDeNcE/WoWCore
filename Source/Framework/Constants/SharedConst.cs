...
namespace Framework.Constants
{
    public class SharedConst
    {
        ...
        public static long GetMaskForRace(Race raceId)
        {
            ...
            return raceBit is >= 0 and < sizeof(long) * 8 ? 1L << raceBit : 0;
        }

        public static bool IsActivePetSlot(PetSaveMode slot) => slot is >= PetSaveMode.FirstActiveSlot and < PetSaveMode.LastActiveSlot;

        public static bool IsStabledPetSlot(PetSaveMode slot) => slot is >= PetSaveMode.FirstStableSlot and < PetSaveMode.LastStableSlot;

...
namespace Framework.Constants;
    ...
    public enum GameObjectFlags
    {
        ...
        IgnoreCurrentStateForUseSpellExceptUnlocked = 0x40000,   // Allows casting use spell without checking current state except unlocking unlocked GameObjects (opening open gameobjects and closing closed gameobjects)

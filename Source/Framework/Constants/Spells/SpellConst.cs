...
namespace Framework.Constants;
    ...
    public enum Mechanics
    {
        ...
        ImmuneToMovementImpairmentAndLossControlMask = (1 << Charm) | (1 << Disoriented) | (1 << Fear) | (1 << Root) | (1 << Sleep) | (1 << Snare) | (1 << Stun) | (1 << Freeze) | (1 << Silence) | (1 << Disarm) | (1 << Knockout) | (1 << Polymorph) | (1 << Banish) | (1 << Shackle) | (1 << Turn) | (1 << Horror) | (1 << Daze) | (1 << Sapped)
    }
    ...
    public enum SpellCustomErrors
    {
        ...
        CannotCastThatWithAuraOfReckoningTalent                                      = 650,  // You cannot cast that while Aura of Reckoning is talented.
    ...
    public enum SpellAttr8 : uint
    {
        ...
        NameChangedDuringTransform                = 0x400,      // 10
        Unk11                                     = 0x800,      // 11
    ...
    public enum SpellEffectName
    {
        ...
        ResurrectWithAura                         = 172,        // Aoe Resurrection
    ...
    {
        None                                      = 0x0,
        Heartbeat                                 = 0x01,       // 00 Killed by aggressor - not sure about this flag
        ...
        MeleeBasedTriggerMask                     = DealMeleeSwing | TakeMeleeSwing | DealMeleeAbility | TakeMeleeAbility | DealRangedAttack | TakeRangedAttack | DealRangedAbility | TakeRangedAbility
    }
    ...
    public enum ProcAttributes
    {
        ...
        ReqSpellMod                               = 0x08,       // requires triggering spell to be affected by procing aura to drop charges
        UseStacksForCharges                       = 0x10,       // consuming proc drops a stack from procing aura instead of charge

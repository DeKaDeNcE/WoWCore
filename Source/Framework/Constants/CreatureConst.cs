...
namespace Framework.Constants;
    ...
    public enum UnitFlags : uint
    {
        ...
        Sheathe                                           = 0x40000000,
        Immune                                            = 0x80000000,
        Disallowed                                        = ServerControlled | NonAttackable | RemoveClientControl | PlayerControlled | Rename | Preparation | NotAttackable1 | Looting | PetInCombat | PvpEnabling | NonAttackable2 | Pacified | Stunned | InCombat | OnTaxi | Disarmed | Confused | Fleeing | Possessed | Skinnable | Mount | Unk28 | PreventEmotesFromChatText | Sheathe | Immune,
    ...
    public enum UnitFlags2 : uint
    {
        ...
        SuppressHighlightWhenTargetedOrMousedOver         = 0x80000,
    ...
    public enum UnitFlags3 : uint
    {
        ...
        Unk30                                             = 0x40000000,
        Unk31                                             = 0x80000000,
        Disallowed                                        = Unk0 | GarrisonPet | AlternativeDefaultLanguage | IgnoreCombat | SuppressNpcFeedback | Unk10 | Unk11 | Unk12 | AlreadySkinned | Unk20 | Unk21 | Unk23 | ForceHideNameplate | Unk25 | Unk26 | Unk27 | Unk28 | Unk29 | Unk30 | Unk31, // Skip
    ...
    public enum CreatureStaticFlags4 : uint
    {
        ...
        HideInCombatLog                                   = 0x02000000, // UnitFlags2 0x2000000, Original Description: Don't Generate Combat Log When Engaged With NPCs
    ...
    public enum CreatureFlagsExtra : uint
    {
        ...
        IgnoreFeignDeath                                  = 0x10000,    // Creature ignores feign death
